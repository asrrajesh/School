...
def get_next_question_version(
    ...
    try:
        pipeline = [
            ...
            # $max ignores documents that don't have "version" at all, so this
            # stays correct for chapters that were generated before this change.
...
def save_generated_questions(
    ...
    """
    Save AI-generated questions to the 'questions' collection, auto-assigning
    the next version number for this class/subject/chapter/assessment combo.
    ...
    try:
        ...
        version = get_next_question_version(
            class_name, subject, chapter, assessment_category, assessment_number
        )
        document = {
            "class": class_name,
            "subject": subject,
